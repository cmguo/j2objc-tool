...
@interface JavaUtilHashMap_TreeNode : JavaUtilLinkedHashMap_LinkedHashMapEntry {
 @public
  __unsafe_unretained JavaUtilHashMap_TreeNode *parent_;
  __unsafe_unretained JavaUtilHashMap_TreeNode *left_;
  __unsafe_unretained JavaUtilHashMap_TreeNode *right_;
  __unsafe_unretained JavaUtilHashMap_TreeNode *prev_;
  jboolean red_;
}
